...
BotLevel = Literal["easy", "normal", "strong"]
...
class PreviewMoveResponse(BaseModel):
    ...
    enemyLibertyBefore: int = 0     # most-threatened enemy group's OPEN before this move
    enemyLibertyAfter: int = 0      # ...and after this move
    nearEncircle: bool = False
    enemyLibertyStatus: str = ""    # Safe/Room/Pressured/Critical/Closed or JA equivalents      # 包囲寸前: this move drops an enemy group to OP1 / OPEN 1    # enemy cells flipped by enclosure (囲み)
    lockGain: int = 0
