  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 14, color: "#475569", lineHeight: 1.6, marginTop: 8 }}>
        ...
        Quick 5×5 は短時間対戦、練習 5×5 は OPEN と包囲を覚える導入盤です。
      </p>
      ...
      <Mech name="Quick 5×5" body="競技用の短時間版です。通常開始の5×5なので、バランス確認や短い対戦に向いています。" />
      <Mech name="練習 5×5" body="初回理解用の導入盤です。OPENと包囲を早く体験するための配置で、ボットはTutorとして弱めに動きます。繰り返し遊ぶ場合はQuick 5×5か標準 7×7を使います。" />

      <div style={card}>
        <div style={{ fontWeight: 900, fontSize: 14.5 }}>勝敗</div>
        <div style={{ fontSize: 13.5, color: "#475569", lineHeight: 1.6, marginTop: 4 }}>
          最後に陣地（マス）が多い方の勝ちです。標準・Quickでは後手に少しコミが付きます。練習 5×5 は学習用なのでコミ0です。
        </div>
      </div>
