...
export async function createGame(payload={}){return request("/games",{method:"POST",body:JSON.stringify(payload)});}
...
export async function getThreat(gameId){return listFrom(await request(`/games/${gameId}/threat`),"threats");}
